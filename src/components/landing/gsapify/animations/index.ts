import { AboutTimeline } from '@components/landing/gsapify/animations/AboutTimeline.ts';
...
import { SkillsTimeline } from '@components/landing/gsapify/animations/SkillsTimeline.ts';
